...
class _ClaimRequestScreenState extends State<ClaimRequestScreen> {
  ...
  Future<void> _fetchClaimRequests() async {
    try {
      final claimRequestProvider = Provider.of<ClaimRequestProvider>(context, listen: false);
      final searchResult = await claimRequestProvider.get(retrieveAll: true);
              ...
              : RefreshIndicator(
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      final isExpanded = _expandedCards.contains(claim.claimRequestId);
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                Center(
                                  child: TextButton.icon(
                                    onPressed: () {
                                      setState(() {
                                        if (isExpanded) {
                                          _expandedCards.remove(claim.claimRequestId);
                                        } else {
                                          _expandedCards.add(claim.claimRequestId!);
                                        }
                                      });
                                    },
                                    icon: Icon(
                              ...
                              if (isExpanded && (claim.comment != null && claim.comment!.isNotEmpty)) ...[
                                const SizedBox(height: 12),
